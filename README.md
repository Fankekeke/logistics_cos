### 基于SpringBoot + Vue的同城物流配送系统.

即时配送、末端物流、配送调度、运力资源管理、电子面单系统、轨迹实时追踪、路径规划优化、自动结算分账、众包配送管理

##### 管理员端：全业务运营与风控管理
###### 数据统计/图表： 通过可视化看板实时监控订单总量、业务分布及增长趋势，为经营策略调整提供精准数据支撑。

###### 订单/评价管理： 全程监管配送流程并处理用户评价，通过对服务质量的数字化干预，提升平台整体口碑。

###### 用户/员工管理： 统一维护客户与配送员档案，实现多角色权限分配与组织架构管控，保障系统运行稳健有序。

###### 员工收益/提现审核： 动态核算配送员报酬并严格审核提现申请，确保资金流向清晰合规，平衡运力成本与激励。

###### 物品/兑换管理： 负责商城物资上架与积分兑换记录核销，通过福利体系增强用户粘性与活跃度。

###### 优惠券/地址管理： 灵活配置营销券策略并规范用户地址信息库，从获客成本与配送效率两端优化运营效能。

##### 配送员端：高效接单与收益结算
###### 接单中心/我的订单： 实时推送周边配送任务，支持快速抢单与订单生命周期管理，确保同城配送的高效流转。

###### 订单统计/收益： 自动汇总每日配送业绩与酬金明细，让配送员随时掌握收入动态，提升个人作业的成就感。

###### 提现申请/评价： 提供自助提现通道并支持查看用户反馈，辅助配送员根据评价自我优化，提升服务满意度。

##### 用户端：便捷下单与会员福利
###### 用户下单/沙盒支付： 提供极简的下单流程并集成模拟支付接口，确保资金交易流程安全，享受极致的即时配送服务。

###### 收货地址/订单： 自主管理常用地址并实时追踪物流动态，实现从下单到签收的全过程可视化，保障货物交付。

###### 优惠券/物品兑换： 领取平台营销福利并使用积分兑换实物奖励，通过多样的会员活动降低个人物流成本。

###### 评价/信息变更： 支持对服务质量进行星级评定，并可随时更新个人档案，确保用户在平台内的交互体验持续优化。
